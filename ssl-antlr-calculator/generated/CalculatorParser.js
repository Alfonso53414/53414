...
3,8,76,8,8,1,8,0,0,9,0,2,4,6,8,10,12,14,16,0,1,1,0,8,9,75,0,18,1,0,0,0,2,
21,1,0,0,0,4,32,1,0,0,0,6,43,1,0,0,0,8,48,1,0,0,0,10,50,1,0,0,0,12,53,1,
0,0,0,14,61,1,0,0,0,16,75,1,0,0,0,18,19,3,2,1,0,19,20,5,0,0,1,20,1,1,0,0,
0,21,22,5,10,0,0,22,23,5,13,0,0,23,25,5,1,0,0,24,26,3,4,2,0,25,24,1,0,0,
0,25,26,1,0,0,0,26,27,1,0,0,0,27,28,5,2,0,0,28,29,5,3,0,0,29,30,3,6,3,0,
30,31,5,4,0,0,31,3,1,0,0,0,32,37,5,13,0,0,33,34,5,5,0,0,34,36,5,13,0,0,35,
...
0,0,48,47,1,0,0,0,49,9,1,0,0,0,50,51,3,14,7,0,51,52,5,6,0,0,52,11,1,0,0,
0,53,54,5,11,0,0,54,55,5,7,0,0,55,56,5,12,0,0,56,57,5,1,0,0,57,58,3,14,7,
0,58,59,5,2,0,0,59,60,5,6,0,0,60,13,1,0,0,0,61,66,3,16,8,0,62,63,7,0,0,0,
63,65,3,16,8,0,64,62,1,0,0,0,65,68,1,0,0,0,66,64,1,0,0,0,66,67,1,0,0,0,67,
15,1,0,0,0,68,66,1,0,0,0,69,76,5,13,0,0,70,76,5,14,0,0,71,72,5,1,0,0,72,
73,3,14,7,0,73,74,5,2,0,0,74,76,1,0,0,0,75,69,1,0,0,0,75,70,1,0,0,0,75,71,
...
export default class CalculatorParser extends antlr4.Parser {
    ...
    static symbolicNames = [ null, null, null, null, null, null, null, null, 
                             null, null, "FUNCTION", "CONSOLE", "LOG", "Identifier", 
                             "Number", "WS" ];
	...
	functionBody() {
	    ...
	    try {
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        while((((_la) & ~0x1f) === 0 && ((1 << _la) & 26626) !== 0)) {
	            this.state = 40;
	            this.statement();
	            this.state = 45;
	            this._errHandler.sync(this);
...
CalculatorParser.FUNCTION = 10;
CalculatorParser.CONSOLE = 11;
CalculatorParser.LOG = 12;
